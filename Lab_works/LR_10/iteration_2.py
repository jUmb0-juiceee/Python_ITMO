...
def integrate_async(f: callable, a: float, b: float, *, n_jobs: int = 2, n_iter: int = 1000):
    """
        Считает интеграл переданной функции методом левых прямоугольников, разбивая всю работу на несколько потоков.
...
#print(round(integrate_async(math.sin, 0, math.pi), 5))
